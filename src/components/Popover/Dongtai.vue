...
<script>
import videoDt from "./Dongtai/Video.vue";
import zhiboDt from "./Dongtai/Zhibo.vue";
import zhuanlanDt from "./Dongtai/Zhuanlan.vue";
export default {
  data() {
    return {
      active: "",
